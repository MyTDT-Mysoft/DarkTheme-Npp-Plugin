...
const NPPM_DISABLEAUTOUPDATE = (NPPMSG + 95) ' 2119 in decimal
' VOID NPPM_DISABLEAUTOUPDATE(0, 0)

const	RUNCOMMAND_USER = (WM_USER + 3000)
const NPPM_GETFULLCURRENTPATH	= (RUNCOMMAND_USER + FULL_CURRENT_PATH)
const NPPM_GETCURRENTDIRECTORY = (RUNCOMMAND_USER + CURRENT_DIRECTORY)
const NPPM_GETFILENAME = (RUNCOMMAND_USER + FILE_NAME)
const NPPM_GETNAMEPART		= (RUNCOMMAND_USER + NAME_PART)
const NPPM_GETEXTPART			= (RUNCOMMAND_USER + EXT_PART)
const NPPM_GETCURRENTWORD		= (RUNCOMMAND_USER + CURRENT_WORD)
...
const NPPM_GETCURRENTLINE		=	(RUNCOMMAND_USER + CURRENT_LINE)
' INT NPPM_GETCURRENTLINE(0, 0)
' return the caret current position line
const NPPM_GETCURRENTCOLUMN		=	(RUNCOMMAND_USER + CURRENT_COLUMN)
' INT NPPM_GETCURRENTCOLUMN(0, 0)
' return the caret current position column

' Notification code
const NPPN_FIRST = 1000
const NPPN_READY = (NPPN_FIRST + 1) ' To notify plugins that all the procedures of launchment of notepad++ are done.
'scnNotification->nmhdr.code = NPPN_READY;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = 0;

const NPPN_TBMODIFICATION = (NPPN_FIRST + 2) ' To notify plugins that toolbar icons can be registered
'scnNotification->nmhdr.code = NPPN_TB_MODIFICATION;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = 0;

const NPPN_FILEBEFORECLOSE = (NPPN_FIRST + 3) ' To notify plugins that the current file is about to be closed
'scnNotification->nmhdr.code = NPPN_FILEBEFORECLOSE;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILEOPENED = (NPPN_FIRST + 4) ' To notify plugins that the current file is just opened
'scnNotification->nmhdr.code = NPPN_FILEOPENED;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILECLOSED = (NPPN_FIRST + 5) ' To notify plugins that the current file is just closed
'scnNotification->nmhdr.code = NPPN_FILECLOSED;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILEBEFOREOPEN = (NPPN_FIRST + 6) ' To notify plugins that the current file is about to be opened
'scnNotification->nmhdr.code = NPPN_FILEBEFOREOPEN;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILEBEFORESAVE = (NPPN_FIRST + 7) ' To notify plugins that the current file is about to be saved
'scnNotification->nmhdr.code = NPPN_FILEBEFOREOPEN;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILESAVED = (NPPN_FIRST + 8) ' To notify plugins that the current file is just saved
'scnNotification->nmhdr.code = NPPN_FILESAVED;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_SHUTDOWN = (NPPN_FIRST + 9) ' To notify plugins that Notepad++ is about to be shutdowned.
'scnNotification->nmhdr.code = NPPN_SHUTDOWN;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = 0;

const NPPN_BUFFERACTIVATED = (NPPN_FIRST + 10) ' To notify plugins that a buffer was activated (put to foreground).
'scnNotification->nmhdr.code = NPPN_BUFFERACTIVATED;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = activatedBufferID;

const NPPN_LANGCHANGED = (NPPN_FIRST + 11) ' To notify plugins that the language in the current doc is just changed.
'scnNotification->nmhdr.code = NPPN_LANGCHANGED;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = currentBufferID;

const NPPN_WORDSTYLESUPDATED = (NPPN_FIRST + 12) ' To notify plugins that user initiated a WordStyleDlg change.
'scnNotification->nmhdr.code = NPPN_WORDSTYLESUPDATED;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = currentBufferID;

const NPPN_SHORTCUTREMAPPED = (NPPN_FIRST + 13) ' To notify plugins that plugin command shortcut is remapped.
...
const NPPN_FILEBEFORELOAD = (NPPN_FIRST + 14) ' To notify plugins that the current file is about to be loaded
'scnNotification->nmhdr.code = NPPN_FILEBEFOREOPEN;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = NULL;

const NPPN_FILELOADFAILED = (NPPN_FIRST + 15)  ' To notify plugins that file open operation failed
'scnNotification->nmhdr.code = NPPN_FILEOPENFAILED;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_READONLYCHANGED = (NPPN_FIRST + 16)  ' To notify plugins that current document change the readonly status,
...
const NPPN_DOCORDERCHANGED = (NPPN_FIRST + 17)  ' To notify plugins that document order is changed
'scnNotification->nmhdr.code = NPPN_DOCORDERCHANGED;
'scnNotification->nmhdr.hwndFrom = newIndex;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_SNAPSHOTDIRTYFILELOADED = (NPPN_FIRST + 18)  ' To notify plugins that a snapshot dirty file is loaded on startup
'scnNotification->nmhdr.code = NPPN_SNAPSHOTDIRTYFILELOADED;
'scnNotification->nmhdr.hwndFrom = NULL;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_BEFORESHUTDOWN = (NPPN_FIRST + 19)  ' To notify plugins that Npp shutdown has been triggered, files have not been closed yet
'scnNotification->nmhdr.code = NPPN_BEFORESHUTDOWN;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = 0;

const NPPN_CANCELSHUTDOWN = (NPPN_FIRST + 20)  ' To notify plugins that Npp shutdown has been cancelled
'scnNotification->nmhdr.code = NPPN_CANCELSHUTDOWN;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = 0;

const NPPN_FILEBEFORERENAME = (NPPN_FIRST + 21)  ' To notify plugins that file is to be renamed
'scnNotification->nmhdr.code = NPPN_FILEBEFORERENAME;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILERENAMECANCEL = (NPPN_FIRST + 22)  ' To notify plugins that file rename has been cancelled
'scnNotification->nmhdr.code = NPPN_FILERENAMECANCEL;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILERENAMED = (NPPN_FIRST + 23)  ' To notify plugins that file has been renamed
'scnNotification->nmhdr.code = NPPN_FILERENAMED;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILEBEFOREDELETE = (NPPN_FIRST + 24)  ' To notify plugins that file is to be deleted
'scnNotification->nmhdr.code = NPPN_FILEBEFOREDELETE;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILEDELETEFAILED = (NPPN_FIRST + 25)  ' To notify plugins that file deletion has failed
'scnNotification->nmhdr.code = NPPN_FILEDELETEFAILED;
'scnNotification->nmhdr.hwndFrom = hwndNpp;
'scnNotification->nmhdr.idFrom = BufferID;

const NPPN_FILEDELETED = (NPPN_FIRST + 26)  ' To notify plugins that file has been deleted
